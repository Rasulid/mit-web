...
from api.v1.auth.login import get_current_admin
from api.v1.models.course_model import CourseModel
from api.v1.schemas.course_schema import CourseReadSchema, Schema
